...
$snippets[1]->fromArray(array(
    ...
    'name' => 'modMobile',
    'description' => 'Returns mobile if user is set to mobile otherwise it returns full',
    'snippet' => getSnippetContent($sources['source_core'].'/elements/snippets/snippet.modmobile.php'),
),'',true,true);
